    ...
    >
      ...
      <ul>
        <li>
          ...
          <a href="https://outspokn.co">https://outspokn.co</a>, or any website
          of ours that links to this privacy notice
        </li>
        <li>
          Download and use our mobile application (Outspokn), or any other
      ...
      <ul>
        ...
        <li>
          ...
          <a href="mailto:privacy@outspokn.co">privacy@outspokn.co</a>, or by
      ...
      <ul>
        <li>
          <a href="#info-we-collect">WHAT INFORMATION DO WE COLLECT?</a>
        </li>
        <li>
          <a href="#how-we-process">HOW DO WE PROCESS YOUR INFORMATION?</a>
        </li>
        <li>
          <a href="#legal-bases">
        ...
        <li>
          <a href="#data-retention">HOW LONG DO WE KEEP YOUR INFORMATION?</a>
        </li>
        <li>
          <a href="#data-security">HOW DO WE KEEP YOUR INFORMATION SAFE?</a>
        </li>
        <li>
        ...
        <li>
          <a href="#dnt-controls">CONTROLS FOR DO-NOT-TRACK FEATURES</a>
        </li>
        <li>
          <a href="#us-rights">
        ...
        <li>
          <a href="#contact-us">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a>
        </li>
        <li>
      ...
      <h2 id="info-we-collect">WHAT INFORMATION DO WE COLLECT?</h2>
      ...
      <ul>
        <li>
          ...
          mobile device`s microphone, and other features. If you wish to change
      ...
      <h2 id="how-we-process">HOW DO WE PROCESS YOUR INFORMATION?</h2>
      <p>
      ...
      <h2 id="social-logins">HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
      <p>
      ...
      <p>
        ...
        email us at{" "}
        <a href="mailto:privacy@outspokn.com">privacy@outspokn.com</a>.
      </p>

      <h2 id="dnt-controls">CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
      <p>
      ...
      <p>
        To exercise these rights, you can contact us by visiting outspokn.co, by
        emailing us at{" "}
        <a href="mailto:privacy@outspokn.co">privacy@outspokn.co</a>, or by
      ...
      <p>
        ...
        us at <a href="mailto:privacy@outspokn.com">privacy@outspokn.com</a>. We
      ...
      <h2 id="other-regions">DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
      <p>
      ...
      <p>
        ...
        and conditions set by Australias Privacy Act 1988 and New Zealands
      ...
      <p>
        ...
        by using the contact details provided in the section HOW CAN YOU REVIEW,
      ...
      <p>
        ...
        Information Commissioner and a breach of New Zealands Privacy Principles
      ...
      <h2 id="contact-us">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
      <p>
